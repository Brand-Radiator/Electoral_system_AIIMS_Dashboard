        ...
        <Card.Body>
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="validationCustom01">
              ...
              <Form.Control required type="text" placeholder="Designation" defaultValue="designation" />
              <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
            </Form.Group>

            <Form.Group className="mb-3" controlId="validationCustom02">
              <Form.Label>Profile Name</Form.Label>
              <Form.Control required type="text" placeholder="Profile Name" defaultValue="Profile Name" />
              <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
            </Form.Group>

            <Form.Group className="mb-3" controlId="validationCustom02">
              <Form.Label>Slogan</Form.Label>
              <Form.Control required type="text" placeholder="Slogan" defaultValue="Slogan" />
              <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
            </Form.Group>

            <Form.Group className="mb-3" controlId="validationCustom02">
              <Form.Label>State</Form.Label>
              <Form.Control required type="text" placeholder="State" defaultValue="State" />
              <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
            </Form.Group>
