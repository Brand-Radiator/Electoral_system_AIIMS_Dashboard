  ...
  const deleteItem = async (itemId: string) => {
    try {
      const response = await fetch(
        `http://165.22.219.69:5002/api/introduction/${itemId}/${profileId}/${Key_Key}`,
      ...
      alert("Error during edit the banner:");
    }
  };
  useEffect(() => {
...
const Introduction = () => {
  ...
  const handleFetchData = async () => {
    try {
      ...
      // const data = await api.fetchData("http://165.22.219.69:5002/api/introduction");
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        const response = await fetch(
          `http://165.22.219.69:5002/api/introduction/${profileId}/${Key_Key}`,
  ...
  const handleUpdate = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        const response = await fetch(
          `http://165.22.219.69:5002/api/introduction/${objectId}/${profileId}/${Key_Key}`,
  ...
  // console.log("introductionData ----", introductionData.length);
                ...
                <Col lg={6}>
                  ...
                  >
                    ...
                    <Form.Group>
                      <Form.Label className="d-flex  pt-2justify-content-start font-weight-bold">
                        <h5>
                          Paragraph <span style={{ color: "red" }}> *</span>
                        </h5>
                      </Form.Label>
                      <Form.Control
                        type="text"
