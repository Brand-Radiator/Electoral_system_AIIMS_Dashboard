...
const DeletesportrequirementpolicyPage: React.FC<Parent> = ({ userData }) => {
  ...
  const deleteItem = async (itemId: string) => {
    try {
      const response = await fetch(
        `http://165.22.219.69:5002/api/delete/sportrequirementpolicy/${itemId}/${profileId}/${Key_Key}`,
        {
          method: "PATCH",
          credentials: "include",
        }
  ...
  return (
    <>
      <>
        <Card>
          <Card.Body>
            <h4>Delete sport Requirement Policy Page</h4>
...
const UpdatesportrequirementpolicyItem: React.FC<Props> = ({
  itemId,
  parentId,
  innerdata,
}) => {
  ...
  const UpdateProtySpotItem = async (
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        const response = await fetch(
          `http://165.22.219.69:5002/api/update/sportrequirementpolicy/${parentId}/sportrequirementpolicyitem/${itemId}/${profileId}/${Key_Key}`,
          // `http://165.22.219.69:5002/api/update/sportrequirementpolicy/${parentId}/sportrequirementpolicyitem/${itemId}`,
...
const DeletesportrequirementpolicyPageItem: React.FC<Parent> = ({ id }) => {
  const [validated, setValidated] = useState<boolean>(false);
  ...
  useEffect(() => {
    fetch(`http://165.22.219.69:5002/api/sportrequirementpolicy/${id}`)
      .then((response) => response.json())
  ...
  const deleteItem = async (itemId: string) => {
    try {
      const response = await fetch(
        `http://165.22.219.69:5002/api/delete/sportrequirementpolicy/${id}/sportrequirementpolicyitem/${itemId}/${profileId}/${Key_Key}`,
        {
          method: "PATCH",
          credentials: "include",
        }
    ...
    <>
      {isEditItem ? (
        <Row>
          <Col lg={10}>
            {innerdata && (
              <UpdatesportrequirementpolicyItem
                itemId={isEditItem}
                parentId={id}
                innerdata={innerdata}
              />
        ...
        <>
          <h4>Update or delete sport Requirement Policy Data</h4>
...
const AddsportrequirementpolicyPageItem: React.FC<Parent> = ({ id }) => {
  const [validated, setValidated] = useState<boolean>(false);
  const [sportName, setSportName] = useState("");
  const [sportDetails, setSportDetails] = useState("");
  const [image, setImage] = useState<File | null>(null);
  ...
  const addOrgItem = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        const response = await fetch(
          `http://165.22.219.69:5002/api/sportrequirementpolicy/${id}/${profileId}/${Key_Key}`,
      ...
      <Card>
        <Card.Body>
          <Form
            ...
            encType="multipart/form-data"
          >
            <h4>Add sport Requirement Policy Item</h4>
            {isError && (
              <Alert variant="danger" className="my-2">
                {isResponse}
              </Alert>
...
const Sportrequirementpolicy = () => {
  ...
  useEffect(() => {
    // fetch("http://165.22.219.69:5002/api/sportrequirementpolicy")
    fetch("http://165.22.219.69:5002/api/sportrequirementpolicy")
      .then((response) => response.json())
      .then((res) => setData(res));
  }, []);
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        const response = await fetch(
          `http://165.22.219.69:5002/api/sportrequirementpolicy/${profileId}/${Key_Key}`,
          {
            method: "POST",
            body: formData,
            credentials: "include",
  ...
  const handleUpdate = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        const response = await fetch(
          `http://165.22.219.69:5002/api/update/sportrequirementpolicy/${objectId}/${profileId}/${Key_Key}`,
          {
            method: "PATCH",
            body: formData,
            credentials: "include",
        ...
        <Card>
          <Card.Body>
            <Row>
              {data.length === 0 ? (
                <Col lg={6}>
                  <Form
                    ...
                    encType="multipart/form-data"
                  >
                    <h4>Add sport Requirement Policy Page</h4>
                    {isError && (
                      <Alert variant="danger" className="my-2">
                        {isResponse}
                      </Alert>
                ...
                <Col lg={6}>
                  <Form
                    ...
                    encType="multipart/form-data"
                  >
                    <h4>Update sport Requirement Policy Page</h4>
                    {isError && (
                      <Alert variant="danger" className="my-2">
                        {isResponse}
                      </Alert>
              ...
              {/* -------------------------- update data--------------------------------------------- */}
              <Col lg={6}>
                {data && <DeletesportrequirementpolicyPage userData={data} />}
              </Col>
            </Row>
            <div
            ...
            <Row>
              <Col lg={6}>
                <AddsportrequirementpolicyPageItem id={objectId} />
              </Col>
              <Col lg={6}>
                {objectId && data && (
                  <DeletesportrequirementpolicyPageItem id={objectId} />
                )}
              </Col>
            </Row>
          </Card.Body>
...
export default Sportrequirementpolicy;
