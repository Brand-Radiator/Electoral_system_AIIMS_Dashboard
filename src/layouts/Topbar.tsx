...
import TimerAuthCheck from "../components/TimerAuthCheck";
...
import profilePic from "../assets/images/users/admin-avatar.png";
// import logoLight from "../assets/images/BSSA-logo.png";
// import logoSm from "../assets/images/BSSA-logo.png";
// import logoDark from "../assets/images/BSSA-logo.png";

import logoLight from "../assets/images/logoAIIMS2.jpg";
import logoSm from "../assets/images/logoAIIMS2.jpg";
import logoDark from "../assets/images/logoAIIMS2.jpg";
...
const Topbar = ({
  ...
  const togglePasswordResetModal = () => {
    if (!isPassReset) {
      setPasswordResetModal((prevstate) => !prevstate);
    }
  };
  ...
  // Close modal when password is successfully reset
  // useEffect(() => {
  //   if (isPasswordReset) {
          ...
          <ul className="list-unstyled topnav-menu float-end mb-0">
            ...
            <li className="dropdown notification-list topbar-dropdown">
              <ProfileDropdown
                ...
                // profilePic={`${API_BASE_URL}/${user?.imageUrl?.replace(
                //   "public/images/",
                //   "images/"
                // )}`}
      ...
      <div className="container">
        {!isPasswordReset && (
          <Modal
            ...
            onHide={togglePasswordResetModal}
            size="lg"
            centered
            backdrop="static" // Prevent closing on clicking outside
            keyboard={false} // Prevent closing on pressing Esc key
          >
            <Modal.Header
            //  closeButton
            ></Modal.Header>
